...
**Örnek:**
\`\`\`erkek @etiket
erkek @etiket blabla 123

erkek 686185592899633200
erkek 686185592899633200 blabla 123\`\`\``)).then(a => a.delete({timeout: 10000}));
...
${message.author} **Kayıt sayın:** \`c!profil yazarak görebilirsin!\`
